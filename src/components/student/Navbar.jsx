...
const navigate = useNavigate()
  ...
  return (
    <div className={`flex justify-between items-center px-4 sm:px-10 md:px-14 lg:px36 boreder-b border-gray-500 py-4 ${isCourseListPage ?'bg-white' : 'bg-cyan-100/70'} `}>
     <Link to={'/'} >
   <img src={assets.logo} alt="no internet" className='w-28 lg:w-32 cursor-pointer'/>  </Link>  
